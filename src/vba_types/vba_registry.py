...
class VBARegistry:
    ...
    def register_binary(self, op: str, type_left: str, type_right: str, handler: Callable):
        self._binary_ops[(op, type_left, type_right)] = handler

    def execute_binary_op(self, op: str, left: VBAValue, right: VBAValue) -> VBAValue:
    ...
    def _get_vba_error_msg(self, op: str, left: VBAValue, right: VBAValue) -> str:
        return f"Run-time error '13': Type mismatch for {left.type_name} {op} {right.type_name}"
