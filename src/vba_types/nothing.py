...
class VBANothing:
    ...
    def __add__(self: T, other): raise TypeError("VBA Error 91: Object variable or With block variable not set")
    def __sub__(self: T, other): raise TypeError("VBA Error 91: Object variable or With block variable not set")
    def __mul__(self: T, other): raise TypeError("VBA Error 91: Object variable or With block variable not set")
    def __truediv__(self: T, other): raise TypeError("VBA Error 91: Object variable or With block variable not set")
